...
const ProjectCard = ({ project }) => {
    ...
    return (
        <div className='flex justify-center items-center'>
            <div className="card card-compact bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] w-full sm:w-80 md:w-96 shadow-xl shadow-gray-700">
                <figure>
                    <img
